...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This follower is customized so that the imfp is always the same. The imfp
% of each channel is still computed and used to deterine the scattering
% channel
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [events,pagdata,polymdata]=TrajectoryFollowerFixedIMFP(event,scattdata,scatt_Elim,xyzglobal,pagdata,polymdata,~)
%% Initializations
