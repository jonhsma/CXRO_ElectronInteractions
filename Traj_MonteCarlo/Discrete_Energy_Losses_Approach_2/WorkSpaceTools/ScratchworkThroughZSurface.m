...
figure(666);
hold off
h_up_0 = histogram([ps0pEV.Ein],binEdges,'Normalization','pdf');
hold on;
h_up_0p10 = histogram([ps0p1pEV.Ein],binEdges,'Normalization','pdf');
h_up_0p25 = histogram([ps0p25pEV.Ein],binEdges,'Normalization','pdf');
h_up_0p50 = histogram([ps0p50pEV.Ein],binEdges,'Normalization','pdf');
h_up_2p50 = histogram([ps2p50pEV.Ein],binEdges,'Normalization','pdf');

figure(8023);
marker = '-';
hold off
plot(binCenter,h_up_0.Values,marker)
hold on
plot(binCenter,h_up_0p10.Values,marker)
plot(binCenter,h_up_0p25.Values,marker)
plot(binCenter,h_up_0p50.Values,marker)
plot(binCenter,h_up_2p50.Values,marker)
set(gca,'YScale','Linear');
...
figure(666);
hold off
h_dn_0p10 = histogram([ps0p1nEV.Ein],binEdges,'Normalization','pdf');
hold on;
h_dn_0p25 = histogram([ps0p25nEV.Ein],binEdges,'Normalization','pdf');
h_dn_0p50 = histogram([ps0p50nEV.Ein],binEdges,'Normalization','pdf');
h_dn_2p50 = histogram([ps2p50nEV.Ein],binEdges,'Normalization','pdf');

figure(8024);
marker = '-';
hold off
plot(binCenter,h_dn_0p10.Values,marker)
hold on
plot(binCenter,h_dn_0p25.Values,marker)
plot(binCenter,h_dn_0p50.Values,marker)
plot(binCenter,h_dn_2p50.Values,marker)
set(gca,'YScale','Linear');
