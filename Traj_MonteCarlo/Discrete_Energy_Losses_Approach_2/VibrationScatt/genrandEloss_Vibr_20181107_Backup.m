...
[minval,idxtmp]=min(abs(E(idx1)-incidentE));
idx1=idx1(idxtmp);

idx2=find(E==incidentE);

idx3=find(E>incidentE);
[minval,idxtmp]=min(abs(E(idx3)-incidentE));
idx3=idx3(idxtmp);
...
Elchoose=idxtmp; % the EL value [which vibrational mode?]
Eloss=(scattdata.El_min(Elchoose)+scattdata.El_max(Elchoose))/2;
