...
%%% Scattering is supposedly isotropic.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [events,pagdata,polymdata]=trajcalc3_JHSM_toy(event,scattdata,scatt_Elim,xyzglobal,pagdata,polymdata,logfile_fid)
global illustration;
...
%             imfp=imfp_vibr; % don't do this
        ...
        %%% Since theta has been randmoized, use a simplistic version to
        %%% ensure isotropic scattering outcome
        %cosval=cos(theta_old+theta);
        cosval=cos(theta);
        sineval=sqrt(1-cosval^2); %sine is always positive here
