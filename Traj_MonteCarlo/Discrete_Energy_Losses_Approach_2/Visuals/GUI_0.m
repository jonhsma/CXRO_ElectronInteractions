...
% Last Modified by GUIDE v2.5 14-Nov-2018 16:58:36
...
guidata(hObject, handles);
    ...
    if exist('scanArchive','var')
        set(handles.pushbutton1,'string','Visualize/Hierachy','enable','on')    
        scanArchiveGUI  =   scanArchive;    
    else
        set(handles.pushbutton1,'string','Database missing','enable','off')
    end
